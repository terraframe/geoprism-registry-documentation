...
In addition to the above, you can also access the platform through a REST API (See [Chapter 4](../4-external-system-integration/)) that uses the same roles for authentication.
