...
The following sections describe in more detail the capacities of GeoPrism Registry in managing the content being hosted in the platform (see [section 5.1](5.2-content-related-capacities-of-geoprism-registry.md#5.1-content) for further details on the hosted content itself).
