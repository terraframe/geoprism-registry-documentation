...
{% hint style="info" %}
An OAuth Client must first be created in the DHIS2 instance. See the [DHIS2 OAuth Integration page](../../../../readme/current/deployment-and-setup/3.9-dhis2-oauth-integration.md) for more information.
{% endhint %}

1. At the bottom of your External System form, you will see a section for Oauth. Click the “Enable OAuth Integration” button.\
   ![](<../../../../.gitbook/assets/image (73).png>)
2. A form for configuring the OAuth integration should expand. “Client ID”, “Profile Location”, “Token Location” and “Authorization Location” should be filled out automatically, we do NOT recommend changing these values.\
...
{% hint style="danger" %}
The GPR's DHIS2 integration has not been tested on DHIS2 versions above 2.38, or below 2.31. We do not recommend integrating with DHIS2 servers outside of this range, because the GPR could throw unspecified errors during synchronization or worse case scenario it could corrupt your DHIS2 database.
{% endhint %}

Not all versions of DHIS2 have been tested with the GPR. Additionally, some features may not work on some versions. The following table summarizes our findings.
