...
{% hint style="info" %}
An OAuth client must first be created in the DHIS2 instance. See [section 3.9](../../../../readme/current/deployment-and-setup/3.9-dhis2-oauth-integration/) for more information.
{% endhint %}
