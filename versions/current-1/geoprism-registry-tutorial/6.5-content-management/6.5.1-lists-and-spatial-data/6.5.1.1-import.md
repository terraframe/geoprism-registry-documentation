...
2.  If an external system has been registered in GeoPrism Registry (see [section 4](../../../../current/external-system-integration/)), a window will open providing the option for the import to take place from an external system or from your computer. Choose the option that applies.\\
...
3.  If an external system has been registered in GeoPrism Registry (see [section 4](../../../../current/external-system-integration/)) a window will open providing the option for the import to take place from an external system or from your computer. Choose the option that applies.\\
