...
{% hint style="info" %}
ເບິ່ງຂໍ້ [section 4.2.1](../../../current/external-system-integration/4.2-register-and-synchronize-an-external-system/4.2.1-dhis2.md) ກ່ຽວກັບວິທີໃຊ້ການກຳນົດຄ່າ DHIS2 OAuth ໃນການລົງທະບຽນລະບົບພາຍນອກ.
{% endhint %}
