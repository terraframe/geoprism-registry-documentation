...
7. The **Alternative Id Mappings** window opens. It only appears if Source Authorities exist in the system. Optionally, add mappings for columns that hold alternative IDs:
...
8.  If you chose a Hierarchy, the _Hierarchy Matching_ window opens listing the Geo-Object Types considered as parents in to the Geo-Object Type for which the spreadsheet is being imported. The number of parent Geo-Object Types that will be listed depends on the position of the imported Geo-Object Type data in the hierarchy. Fill out the following fields for each parent Geo-Object Type:
