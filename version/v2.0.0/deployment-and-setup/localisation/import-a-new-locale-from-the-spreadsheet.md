...
To set localized values in the system, the localization spreadsheet first needs to be exported and translated (see [Add or edit a locale in the exported localization spreadsheet](add-or-edit-a-locale-in-the-exported-spreadsheet.md)). After this is done, the spreadsheet must be reimported.
