# Import a new locale from the localization spreadsheet

To set localized values in the system, the localization spreadsheet first needs to be exported and translated (see [section 3.4.3](../../../current/deployment-and-setup/3.4-localisation/3.4.3-add-or-edit-a-locale-in-the-exported-spreadsheet.md)). After this is done, the spreadsheet must be reimported.
