...
This section is for System Administrators. It explains how to deploy Geoprism Registry to a server and set it up for your organizations and users.
...
After installation, a typical first setup is: [create your organizations](organization-management/create-organization.md), [invite a Registry Administrator](organization-management/invite-a-user-to-serve-as-the-registry-administrator-for-an-organization.md) for each one, and [set up email](system-email-management.md) so invitations and password resets can be sent.
