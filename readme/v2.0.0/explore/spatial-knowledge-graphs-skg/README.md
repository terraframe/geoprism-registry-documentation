...
See [synchronize-an-external-system](../../external-system-integration/synchronize-an-external-system/ "mention") for more information on how a published SKG can be used.
