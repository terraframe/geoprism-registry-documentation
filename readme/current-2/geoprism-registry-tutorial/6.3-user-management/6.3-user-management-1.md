...
3.  Enter the email address of the person you would like to invite and specify the user role. See [section 5.3](../../../current/geoprism-registry-key-components/5.3-user-roles-and-their-rights) for more information.\\
...
4.  Enter the email address of the person you would like to invite and specify the user role. See [section 5.3](../../../current/geoprism-registry-key-components/5.3-user-roles-and-their-rights) for more information.\\
